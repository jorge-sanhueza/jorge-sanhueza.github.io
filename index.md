---
layout: page
title: Jorge Sanhueza
subtitle: Software Developer building impactful solutions from concept to deployment
---

<div class="contact-info">
  <p>
    <i class="fas fa-map-marker-alt"></i> Santiago, Chile (UTC-3) | 
    <i class="fas fa-globe-americas"></i> Remote | 
    <i class="fas fa-envelope"></i> jrg.sanhueza@gmail.com
  </p>
  
  <p>
    <a href="https://github.com/jorge-sanhueza"><i class="fab fa-github"></i> GitHub</a> • 
    <a href="/Jorge-Sanhueza-CV.pdf" class="cv-download"><i class="fas fa-file-pdf"></i> Download CV</a>
  </p>
</div>
...
#### Transportation Management System – Lead Developer
...
#### Website Migration & Modernization – Lead Developer

_Technologies: Next.js, React, TypeScript, WordPress API, Tailwind CSS_

- **Architected and executed migration** to a modern **React SPA using Next.js**, improving performance metrics and user experience
